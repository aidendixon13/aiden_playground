...
class BaseFilter(BaseAnalysisObject):
    ...
    Attributes:
        ...
        text_value (Optional[str]): Text value for string comparisons.
    ...
    text_value: Optional[str] = Field(default=None, alias="TextValue")
...
class AnalysisRequest(BaseModel):
    ...
    members: List[DimensionMember] = Field(alias="Members")
    analysis_steps: List[BaseAnalysisObject] = Field(alias="AnalysisSteps")
